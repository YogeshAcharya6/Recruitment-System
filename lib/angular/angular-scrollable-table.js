  ...
  angular.module('scrollable-table', [])
    .directive('scrollableTable', ['$timeout', '$q', '$parse', function ($timeout, $q, $parse) {
      return {
        ...
        template: '<div class="scrollableContainer" ng-style="$parent.$parent.page==\'JobDescription\' && {\'height\':\'320px\'} || $parent.$parent.page==\'RecruitmentRequest\' && {\'height\':\'320px\'} || $parent.$parent.page==\'candidates\' && {\'height\':\'320px\'} || $parent.$parent.page==\'Dashboard\' && {\'height\':\'320px\'} || $parent.$parent.page==\'RRSchedule\' && {\'height\':\'320px\'} || $parent.$parent.page==\'InterviewerInterface\' && {\'height\':\'320px\'} || $parent.$parent.page==\'Alerts\' && {\'height\':\'320px\'}">' +
                    '<div class="headerSpacer" style="background-color:#C5C5C5;"></div>' +
                    '<div class="scrollArea" ng-transclude></div>' +
                  '</div>',
        controller: ['$scope', '$element', '$attrs', function ($scope, $element, $attrs) {
			/* alert($scope.$parent.$parent.page); */
		 ...
		 // alert($scope.$parent.$parent.page);
		/* if($scope.$parent.$parent.page == 'workDef'){
			document.getElementById("scrollableDiv").className += " height150";
		}	
		if($scope.$parent.$parent.page == 'approve')
			document.getElementById("scrollableDiv").className += " height430"; */
